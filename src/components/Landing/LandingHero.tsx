        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
          ...
          <div className="flex flex-col items-end">
            <div className="flex items-center space-x-2 sm:space-x-3">
              ...
              <div className="hidden md:flex items-center space-x-1.5 bg-slate-100 dark:bg-slate-900 px-2.5 py-1.5 rounded-lg border border-slate-300 dark:border-slate-800 text-xs shadow-sm">
                <span className="text-slate-500 dark:text-slate-400 font-medium">Industry Profile:</span>
                <select
                  aria-label="Select industry profile"
                  value={profile.industry}
                  onChange={(e) => onSelectProfilePreset(e.target.value)}
                  className="bg-transparent text-slate-900 dark:text-slate-100 font-semibold focus:outline-none cursor-pointer text-xs"
                >
                  ...
                  <option value="legal-lawfirm" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">Legal & Global Law Firm</option>
                  <option value="manufacturing" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">Manufacturing & Aerospace</option>
              ...
              <button
                ...
                className="p-2 rounded-lg bg-slate-100 dark:bg-slate-900 text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-800 border border-slate-300 dark:border-slate-800 transition-all shrink-0 cursor-pointer shadow-sm"
            ...
            <div className="flex items-center space-x-2 text-[11px] text-slate-500 dark:text-slate-400 mt-1.5 font-medium select-none">
